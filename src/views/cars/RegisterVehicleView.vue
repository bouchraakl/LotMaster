      ...
      <form class="form-app d-flex flex-column align-items-start mt-4 h-100 gap-3" @submit.prevent="submitForm">
        ...
        <div class="d-flex align-items-center align-self-start gap-3">
          <div class="d-flex flex-column">
            ...
            <input class="form-control" id="plate" style="width: 300px" v-model="vehicle.placa" />
          </div>
        </div>
        <!-- Associated Model -->
        <div class="d-flex align-items-center align-self-start gap-3">
          <div class="d-flex flex-column">
            ...
            <input class="form-control" list="datalistOptions" id="models" placeholder="Search By Model Name ..."
              style="width: 300px" v-model="vehicle.modelo.nome" />
        ...
        <div class="d-flex align-items-center align-self-start gap-3">
          <div class="d-flex flex-column">
            ...
            <input class="form-control" type="number" id="year" style="width: 100px" v-model="vehicle.ano" />
          </div>
          <div class="d-flex flex-column">
            <label for="color" class="form-label">Vehicle Color</label>
            <select class="form-select" id="color" style="width: 200px" v-model="vehicle.cor">
          ...
          <div class="d-flex flex-column">
            ...
            <select class="form-select" id="type" style="width: 200px" v-model="vehicle.tipo">
        ...
        <div class="mt-4 d-flex align-items-center gap-3">
          ...
          <router-link to="/access-vehicle" class="m-0"><button>Access Vehicles</button></router-link>
          <p :class="[
            'error-message',
